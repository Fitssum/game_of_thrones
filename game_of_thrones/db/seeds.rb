...
baratheon = Character.create(char_name:"King Robert Baraheon", img_url:"http://imgur.com/iN5jXWH")
stark = Character.create(char_name:"Eddard Stark", img_url:"http://imgur.com/QgGx5om")
lannister = Character.create(char_name:"Tywin Lannister", img_url:"http://imgur.com/Fr1mRQd")
arryn = Character.create(char_name:"Jon Arryn", img_url:"http://imgur.com/01nVJHL")
tyrell = Character.create(char_name:"Mace Tyrell", img_url:"http://imgur.com/mfk7BIy")
tully = Character.create(char_name:"Hoster Tully", img_url:"http://imgur.com/cOnIvqL")
greyjoy = Character.create(char_name:"Balon Greyjoy", img_url:"http://imgur.com/056ryA5")
martell = Character.create(char_name:"Doran Martell", img_url:"http://imgur.com/eXf02Kx")
